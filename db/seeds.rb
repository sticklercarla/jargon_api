...
household_items = Category.create(title: "kitchen")
food = Category.create(title: "food")
colors_shapes = Category.create(title: "colors")
...
# cat = Word.create(category_id: animals.id, english: "male cat", spanish: "gata", french: "chatte" )
# dog = Word.create(category_id: animals.id, english: "male dog", spanish: "perra", french: "chienne" )
...
animals_length = animals_english.length

for i in 0..animals_length
  Word.create(category_id: food.id, english: animals_english[i], spanish: animals_spanish[i], french: animals_french[i])
end
...
household_items_length = household_items_english.length

for i in 0..household_items_length
  Word.create(category_id: food.id, english: household_items_english[i], spanish: household_items_spanish[i], french: household_items_french[i])
end
...
food_length = food_english.length
...
colors_shapes_length = colors_shapes_english.length
...
relationships_length = relationships_english.length
...
activities_length = activities_english.length
